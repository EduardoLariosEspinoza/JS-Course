...
function nuevaCita(e) {
  ...
  if (editando) {
    ...
    // Sabe cual id es porque en este citaObj esta 'id', que tambien esta en la base de datos de indexedDB
...
function eliminarCita(id) {
  ...
  // Para eliminar un registro de la base de datos se usa delete y se le pasa el id del registro
